...
SWIFT_CLASS("_TtC4Test20CameraViewController")
@interface CameraViewController : ViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified takePicture;
- (void)viewDidLoad;
...
@interface CameraViewController (SWIFT_EXTENSION(Test)) <AVCapturePhotoCaptureDelegate>
...
SWIFT_CLASS("_TtC4Test26CreateMarkerViewController")
@interface CreateMarkerViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified savePhoto;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified finishMarkers;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified StartAR;
- (void)viewDidLoad;
- (IBAction)ARView:(id _Nonnull)sender;
- (IBAction)savePhoto:(id _Nonnull)sender;
- (IBAction)createMarkers:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4Test18MainViewController")
...
SWIFT_CLASS("_TtC4Test11MarkerScene")
@interface MarkerScene : SKScene
...
SWIFT_CLASS("_TtC4Test21PreviewViewController")
@interface PreviewViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified photo;
- (void)viewDidLoad;
- (IBAction)cancel:(id _Nonnull)sender;
- (IBAction)saveButton_touchUpInsideSender:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
